...
namespace AccessibleArena.Core.Models
{
    ...
    public static class Strings
    {
        ...
        public static string BrowserDeclineGuard => L.Get("BrowserDeclineGuard");
        ...
        public static string ScreenSealedPackOpening => L.Get("ScreenSealedPackOpening");
        ...
        public static string BlockSkipGuard_Warning => L.Get("BlockSkipGuard_Warning");
